...
let str5 = "abcdef";
console.log(str5.substr(1,6));  //"bcdefg" 6代表切割的length
console.log(str5.substr(1));   //"bcdefg" [1,str.length-1]
console.log(str5.substr());  //"abcdefg" [0,str.length-1]
console.log(str5.substr(-1));  //"g"
...
constnewArr = arr.filter(Item => word.length > 6);    //筛选出字符串长度大于6的字符串
